...
/* CODE 
function processLength //this will hold 2 parameters
parameter 1 is an array called list, and parameter 2 is a CB that takes numbers only
...
//    return callback = processSum.reduce(function(a,b){
//        return a + b;
//    }, 0)
...
function processDuplicateFree(list, callback) {
    const listFromArray = new Set(list);
    const newArray = Array.from(listFromArray);
...
function getRunnersByTShirtSize(runners, tShirtSize) {
    const getShirtSize = runners.filter(function(item){
...
function tallyUpDonations(runners) {
    const total = runners.reduce(function(a, b){
        return a + b.donation;
    }, 0);
    return total;
}
